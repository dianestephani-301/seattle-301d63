...
function displayPics(){
  ...
  // The photos didn't render to the page. Let has to be assigned to a specific block of code, and it looks like some of these let variables are used in more than one block.
  console.log(viewed);
